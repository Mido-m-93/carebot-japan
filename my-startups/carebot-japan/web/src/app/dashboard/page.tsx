...
export default function DashboardOverviewPage() {
  ...
  return (
    <div className="p-8">
      ...
      {/* Booking URL widget */}
      {bookingSlug && (
        <div className="mb-6 bg-teal-50 border border-teal-200 rounded-xl px-5 py-4 flex items-center justify-between gap-4">
          <div className="min-w-0">
            <p className="text-xs font-medium text-teal-700 mb-1">
              {lang === "ja" ? "患者向け予約リンク" : "Your patient booking link"}
            </p>
            <p className="text-sm text-teal-900 font-mono truncate">
          ...
          <button
            ...
            className="flex-shrink-0 text-xs font-medium text-teal-700 border border-teal-300 px-3 py-1.5 rounded-lg hover:bg-teal-100 transition-colors"
          >
