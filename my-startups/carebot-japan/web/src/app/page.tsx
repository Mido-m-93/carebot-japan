    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 pt-20 pb-24 text-center">
          ...
          <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight text-gray-900 leading-[1.2] mb-6 whitespace-pre-line animate-fade-in-up [animation-delay:100ms]">
            {c.hero_title.split("\n").map((line, i) => (
